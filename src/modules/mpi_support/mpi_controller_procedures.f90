...
module subroutine exchangeDistVarInRow(this,varContainer,name) 
    ...
    do i = 1,this%rowNumX+2*this%xHaloWidth
        bufferFirstIndex = (i-1)*this%rowNumH(this%rowRank)*this%numV+lbound(this%distBuffer(i)%entry,1)
        bufferLastIndex = i*this%rowNumH(this%rowRank)*this%numV-1+lbound(this%distBuffer(i)%entry,1)
    ...
    do j = 0,this%rowSize - 1
        do i = 1,this%rowNumX+2*this%xHaloWidth
            bufferFirstIndex = (i-1)*this%rowNumH(j)*this%numV +lbound(this%distBuffer(i)%entry,1)
            bufferLastIndex = i*this%rowNumH(j)*this%numV-1 +lbound(this%distBuffer(i)%entry,1)
